...
const sorting_sign = require('./sorting.sign-ca5a1045.js');
...
const GroupingRowRenderer = (props) => {
    ...
    if (groupingCustomRenderer) {
        return (index.h(RowRenderer, Object.assign({}, props, { rowClass: "groupingRow", depth: depth }),
            index.h("div", { onClick: e => expandEvent(e, model, itemIndex) }, groupingCustomRenderer(index.h, { name, model, itemIndex, expanded, depth }))));
    }
    return (index.h(RowRenderer, Object.assign({}, props, { rowClass: "groupingRow", depth: depth }),
        index.h("button", { class: { [column_service.GROUP_EXPAND_BTN]: true }, onClick: e => expandEvent(e, model, itemIndex) },
    ...
    render() {
        ...
        for (let rgRow of rows) {
            ...
            for (let rgCol of cols) {
                ...
                const cellNode = index.h(CellRenderer, { renderProps: {
                        schemaModel,
        ...
        return (index.h(index.Host, null, index.h("slot", null), rowsEls));
    }
    ...
    if (p.range) {
        if (p.column.itemIndex >= p.range.x && p.column.itemIndex <= p.range.x1) {
            if (typeof dataProps.class === 'object') {
                dataProps.class[dimension_helpers.FOCUS_CLASS] = true;
            }
        }
    }
    return (index.h(headerCellRenderer.HeaderCellRenderer, { data: p.data, props: dataProps, additionalData: p.additionalData },
        index.h(sorting_sign.SortingSign, { column: p.data }),
...
async function resizeObserver() {
    if (!('ResizeObserver' in window)) {
        const module = await Promise.resolve().then(function () { return require('./resize-observer-d009a220.js'); });
