import { Cell, RangeArea } from "../../types/index";
export declare function isHiddenStore(pos: number): pos is -1;
...
export declare function getRange(start?: Cell | null, end?: Cell | null): RangeArea | null;
