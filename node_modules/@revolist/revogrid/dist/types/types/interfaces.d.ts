...
import type { DimensionCols, DimensionRows, DimensionColPin, DimensionType, MultiDimensionType } from './dimension';
 ...
 */
export interface ExtraNodeFuncConfig {
    refresh: () => void;
}
/**
 ...
 */
export type FocusTemplateFunc = (createElement: HyperFunc<VNode>, detail: FocusRenderEvent) => any;
/**
