...
import { g as getRange, H as ColumnService, o as getCellData, a as isRangeSingleCell } from './column.service-a6a7c415.js';
import { i as isEditInput } from './edit.utils-0ae0db50.js';
import { c as isClear, d as isTab, f as isEnterKeyValue, h as isCopy, g as isCut, j as isPaste, k as isAll } from './key.utils-7c3218d4.js';
import { d as debounce } from './debounce-b3166f78.js';
import { V as ViewportStore, f as calculateRowHeaderSize } from './viewport.store-afa8c4fe.js';
import { H as HEADER_SLOT } from './viewport.helpers-7e7f9dad.js';
import { L as LocalScrollTimer, a as LocalScrollService, g as getContentSize, t as throttle } from './throttle-394e489c.js';
...
const OverlaySelection = class {
    ...
    render() {
        ...
        return (h(Host, { key: '16eb46317cda519daf53f0b347700e8c1cdbd144', class: { mobile: this.isMobileDevice }, onDblClick: (e) => this.onElementDblClick(e), onMouseDown: (e) => this.onElementMouseDown(e), onTouchStart: (e) => this.onElementMouseDown(e, true) }, nodes, h("slot", { key: '8e71ab9946f8b8251aaee867c6551e1fada92c6d', name: "data" })));
    }
    /**
