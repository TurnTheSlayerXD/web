...
import { j as createStore, i as setStore, D as DataStore } from './data.store.js';
import { c as ROW_HEADER_TYPE } from './consts.js';
import './platform.js';
import { g as getItemByPosition } from './dimension.helpers.js';
import { H as HEADER_SLOT, d as defineCustomElement$2 } from './revogr-viewport-scroll2.js';
import { d as defineCustomElement$4 } from './revogr-data2.js';
import { b as defineCustomElement$3 } from './revogr-header2.js';
...
function defineCustomElement() {
    ...
    const components = ["revogr-row-headers", "revogr-data", "revogr-header", "revogr-viewport-scroll", "vnode-html"];
...
export { RevogrRowHeaders as R, ViewportStore as V, addMissingItems as a, getItems as b, isActiveRangeOutsideLastItem as c, getFirstItem as d, getLastItem as e, calculateRowHeaderSize as f, getUpdatedItemsByPosition as g, defineCustomElement as h, isActiveRange as i, recombineByOffset as r, setItemSizes as s, updateMissingAndRange as u };
